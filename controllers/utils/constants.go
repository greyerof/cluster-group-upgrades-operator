...
var CGUEventReasonMsg = map[CGUEventReasonType]string{
	...
	CGUEventReasonBatchUpgradeSuccess: "Policies succesfully remediated in batch clusters",
	...
	CGUEventReasonClusterUpgradeSuccess: "Policies succesfully remediated in cluster",
